import { ProfileData, PromptContext, ProfilePromptItem } from "../types";
  ...
  RESUME: [
    {
      ...
      description:
        "Your target role helps make resume scoring and keyword tailoring more precise.",
      priority: 100,
    },
    {
      field: "currentRole",
      ...
      description:
        "Provides a baseline to evaluate your career progression in resume reviews.",
      priority: 90,
    },
    {
      field: "skills",
      ...
      description:
        "Adding skills enables automated ATS matching and gap analysis.",
      priority: 80,
    },
    {
      field: "education",
      ...
      description:
        "Education details help verify resume credential formatting.",
      priority: 70,
    },
  ],
  INTERVIEW: [
    {
      ...
      description:
        "Tailors practice interview questions to your target position.",
      priority: 100,
    },
    {
      ...
      description:
        "Customizes behavioral and culture-fit scenarios for your target environment.",
      priority: 85,
    },
    {
      field: "skills",
      ...
      description:
        "Generates relevant technical question sets matched to your stack.",
      priority: 80,
    },
    {
      field: "currentStatus",
      ...
      description:
        "Adjusts situational questions for student vs. experienced interviews.",
      priority: 70,
    },
  ],
  ROADMAP: [
  ...
  DASHBOARD: [
    {
      ...
      description:
        "Helps Elev8 recommend the most relevant next steps on your dashboard.",
      priority: 100,
    },
    {
      field: "currentStatus",
      title: "What is your current career status?",
      description:
        "Tailors guidance for your stage (student, switcher, professional).",
      priority: 95,
    },
    {
      field: "skills",
      ...
      description:
        "Unlocks personalized skill gap analysis across all modules.",
      priority: 90,
    },
    {
      field: "targetRole",
    ...
    },
    {
      ...
      description:
        "Ensures roadmap schedules fit your real-world availability.",
      priority: 65,
    },
  ],
  PROFILE: [
