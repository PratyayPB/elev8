    ...
    <div className="space-y-8 max-w-7xl mx-auto pb-10">
      ...
      <PageHeader
        ...
        action={
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-text-primary hover:bg-black/80 dark:hover:bg-brand-secondary-200 text-white dark:text-brand-primary-900 text-sm font-display font-semibold rounded-xl transition-all shadow-sm active:scale-[0.98]"
          >
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-dashboard-card border border-dashboard-cardBorder rounded-[var(--card-radius-lg)] text-center p-8">
          ...
          <Link
            href="/dashboard/roadmaps/new"
            className="px-6 py-2.5 bg-text-primary hover:bg-black/80 dark:hover:bg-brand-secondary-200 text-white dark:text-brand-primary-900 text-sm font-display font-semibold rounded-xl transition-all shadow-sm"
          >
            Generate Roadmap
          </Link>
        </div>
