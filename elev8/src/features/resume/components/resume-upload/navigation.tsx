      ...
      <div className="flex items-center gap-3">
        ...
        {onNext && (
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-display font-semibold text-white dark:text-brand-primary-900 bg-text-primary hover:bg-black/85 dark:hover:bg-brand-secondary-200 disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-sm active:scale-[0.98]"
          >
            {nextLabel}
