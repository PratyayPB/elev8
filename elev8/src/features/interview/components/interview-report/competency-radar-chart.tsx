...
export function CompetencyRadarChart({ overallScores }: CompetencyRadarChartProps) {
  const data = [
    {
      subject: "Technical Accuracy",
      score: overallScores.technicalScore,
      fullMark: 100,
    },
    {
      subject: "Communication",
      score: overallScores.communicationScore,
      fullMark: 100,
    },
    {
      subject: "Problem Solving",
      score: overallScores.problemSolvingScore,
      fullMark: 100,
    },
    {
      subject: "Confidence",
      score: overallScores.confidenceScore,
      fullMark: 100,
    },
    {
      subject: "Practical Depth",
  ...
  return (
    <div className="bg-dashboard-card p-6 sm:p-8 rounded-[var(--card-radius)] border border-dashboard-cardBorder shadow-sm flex flex-col justify-between">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs font-sans text-text-secondary mt-1">
            5-axis breakdown of candidate performance and technical depth
          </p>
        </div>
      </div>
