...
export function Hero() {
  return (
    <section className="pt-36 pb-20 px-4 sm:px-6 max-w-container-max mx-auto flex flex-col items-center text-center">
      {/* Pill Badge */}
      <div className="inline-flex items-center gap-2 bg-[#84E6F6] text-black px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide border border-[#52d6ec] mb-8 shadow-sm">
        <Sparkles className="w-3.5 h-3.5" />
        <span>AI-Powered Career Growth</span>
      </div>

      {/* Main Headline */}
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-black max-w-4xl leading-[1.1] mb-6">
        Unlock Your Professional Potential
      </h1>

      {/* Subtitle */}
      <p className="text-lg md:text-xl text-[#605F5F] max-w-2xl leading-relaxed mb-10">
        Leverage generative intelligence to map your career trajectory, optimize your professional presence, and ace your next big opportunity.
      </p>
      ...
      <div
        id="dashboard"
        className="w-full max-w-5xl bg-white rounded-2xl md:rounded-3xl border border-[#E6E6E6] shadow-xl p-4 md:p-8 overflow-hidden text-left relative group"
      >
        <div className="bg-[#F4F2EE] rounded-xl md:rounded-2xl p-6 border border-[#E6E6E6] space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-[#E6E6E6]">
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-[#999999]">Executive View</span>
              <h3 className="text-2xl font-bold text-black mt-0.5">Career Readiness Dashboard</h3>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-5 border border-[#E6E6E6] flex flex-col justify-between space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-[#605F5F]">Skill Gap Analysis</span>
                <span className="w-2 h-2 rounded-full bg-[#84E6F6]"></span>
              </div>
              <div>
                <div className="text-3xl font-bold text-black">92% Match</div>
                <p className="text-xs text-[#999999] mt-1">Senior Staff Engineer Profile</p>
              </div>
            ...
            <div className="bg-white rounded-xl p-5 border border-[#E6E6E6] flex flex-col justify-between space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-[#605F5F]">ATS Resume Score</span>
                <span className="w-2 h-2 rounded-full bg-[#F7A49E]"></span>
              </div>
              <div>
                <div className="text-3xl font-bold text-black">88/100</div>
                <p className="text-xs text-[#999999] mt-1">Optimized for Tier-1 Tech</p>
              </div>
              <div className="w-full bg-[#F4F2EE] h-2 rounded-full overflow-hidden">
            ...
            <div className="bg-white rounded-xl p-5 border border-[#E6E6E6] flex flex-col justify-between space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-[#605F5F]">Interview Sim Readiness</span>
                <span className="w-2 h-2 rounded-full bg-[#FECD1A]"></span>
              </div>
              <div>
                <div className="text-3xl font-bold text-black">4/5 Passed</div>
                <p className="text-xs text-[#999999] mt-1">System Design & Leadership</p>
              </div>
              <div className="w-full bg-[#F4F2EE] h-2 rounded-full overflow-hidden">
