...
const featuresData = [
  {
    ...
    description: "Create customized, step-by-step learning paths to bridge your skill gaps and quickly reach your career goals.",
  ...
  },
  {
    ...
    description: "Optimize your resume with our intelligent scanner. Build professional resumes that pass ATS checks and get you hired.",
  ...
  },
  {
    ...
    description: "Engage in realistic interview simulations in both text and voice format with instant, actionable feedback.",
...
export function Features() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-background" id="features">
      <div className="max-w-container-max mx-auto">
        ...
        <div className="flex justify-center mb-10 lg:mb-12">
          <div className="flex items-center gap-1 sm:gap-2 bg-[#F0ECE6]/80 p-1.5 rounded-full border border-border-subtle/50 overflow-x-auto max-w-full no-scrollbar">
        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[2.5rem] border border-border-subtle/60 shadow-md p-4 sm:p-6 lg:p-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center min-h-[400px] lg:min-h-[500px]">
            
            {/* Left Image Section */}
            <div className="w-full lg:w-1/2 relative h-[300px] sm:h-[400px] lg:h-full min-h-[300px] lg:min-h-[500px] rounded-2xl md:rounded-[2rem] overflow-hidden bg-muted">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center py-4 lg:py-12 pr-4 lg:pr-12">
              <AnimatePresence mode="wait">
                ...
                >
                  <span className="bg-[#fcf8a1] text-[#7a7415] text-[10px] sm:text-xs font-bold px-3 py-1.5 rounded-full tracking-wider mb-6 uppercase">
                    {activeFeature.badge}
                  </span>
